...
<head>
  ...
  <title>Aplikasi Perpindahan Penduduk</title>
...
}elseif ($this->uri->segment(2) != "auth_login" && $this->uri->segment(1) != "" && $this->uri->segment(1) != "auth" && $this->uri->segment(1) != "pengguna"&& $this->uri->segment(1) != "pengguna_kelurahan" && $this->uri->segment(2) != "auth_forgot_password"&& $this->uri->segment(2) != "auth_register" && $this->uri->segment(2) != "auth_reset_password" && $this->uri->segment(2) != "errors_503" && $this->uri->segment(2) != "errors_403" && $this->uri->segment(2) != "errors_404" && $this->uri->segment(2) != "errors_500" && $this->uri->segment(2) != "utilities_contact" && $this->uri->segment(2) != "utilities_subscribe") {
